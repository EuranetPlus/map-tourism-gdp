export const config = {
	mapTitle: 'tourism-gdp', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-tourism-gdp.vercel.app/', // The url provided when deploying the map on Vercel
